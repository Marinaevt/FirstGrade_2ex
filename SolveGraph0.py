...
Circle = [5+1* np.cos(np.linspace(0, 2 * math.pi, 1000)), -4+1* np.sin(np.linspace(0, 2 * math.pi, 1000))]
plt.plot(Circle[0], Circle[1], 'b')
y2 =(x--4)**2+-2
plt.plot(x, y2, 'b')
Circle = [2+4* np.cos(np.linspace(0, 2 * math.pi, 1000)), -3+4* np.sin(np.linspace(0, 2 * math.pi, 1000))]
plt.plot(Circle[0], Circle[1], 'b')
axes = plt.gca()
axes.set_xlim(-10, 10)
axes.set_ylim(-10, 10)
